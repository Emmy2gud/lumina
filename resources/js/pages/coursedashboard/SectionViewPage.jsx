            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600">course_id</th>
...
{sections.map((section) => (
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{section.title}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{section.course_id}</td>
