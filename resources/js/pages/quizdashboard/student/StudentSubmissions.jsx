...
const StatCard = ({
    ...
    <Card className="p-6 border border-border/40 bg-gradient-to-br from-card/90 via-card/80 to-card/70 backdrop-blur-sm hover:shadow-lg hover:shadow-primary/10 hover:border-primary/20 transition-all duration-300 group">
        <div className="flex items-center justify-between">
            ...
            <div
                className={`p-3 rounded-2xl bg-gradient-to-br shadow-lg ${color}`}
            >
...
const GradingModal = ({ submission, onClose, onGrade }) => {
    ...
    const handleSubmit = () => {
        ...
        if (
            isNaN(numScore) ||
            numScore < 0 ||
            numScore > submission.totalPoints
        ) {
            toast.error(
                `Score must be between 0 and ${submission.totalPoints}`
            );
            return;
        }
...
const StudentSubmissions = () => {
    ...
    const getScoreColor = (submission) => {
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="gap-2 h-9 border-border/40 hover:border-primary/50 hover:bg-primary/5"
                                >
                                            ...
                                            <td className="p-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            toast.info(
                                                                `Messaging ${submission.studentName}...`
                                                            )
                                                        }
                                                    >
