...
const TutorHero = () => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden px-10">
      {/* Background Elements */}
      ...
      <div className="container-lg section-padding relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-500 border border-border/50 text-sm font-medium text-white mb-6 animate-fade-in">
              <Users className="w-4 h-4" />
              <span>Join 10,000+ instructors worldwide</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
              Teach what you know.{" "}
              <span className="gradient-text">Earn while you inspire.</span>
            </h1>

            <p className="text-lg text-text-inverted leading-relaxed mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <Button variant="hero" size="xl" className="text-text-inverted border-border border p-2">
                Become a Tutor
                <ArrowRight className="w-5 h-5" />
              </Button>
              <Button variant="hero-outline" size="xl" className="text-text-inverted">
                Join Tutor Waitlist
              </Button>
            </div>
            ...
            <div className="flex flex-wrap gap-8 mt-12 pt-8 border-t border-border/50 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <div>
                ...
                <p className="text-sm text-white mt-1">Paid to instructors</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-white">2M+</p>
                <p className="text-sm text-white mt-1">Students enrolled</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-white">180+</p>
                <p className="text-sm text-white mt-1">Countries reached</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="absolute -bottom-6 -left-6 bg-card rounded-2xl p-4 shadow-xl border border-border/50 animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-primary-500/100">This month</p>
                  <p className="text-xl font-bold text-primary-500">$4,280</p>
                </div>
              </div>
            </div>
          </div>
